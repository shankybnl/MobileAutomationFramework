...
public class CreateSession  {
	...
	@BeforeMethod
	public  void createDriver(String invokeDriver, Method methodName) throws Exception{

		propertiesFileLoad(invokeDriver);
	...
	public void propertiesFileLoad(String platform) throws Exception{
		...
		File f = new File(file.getAbsoluteFile() + "//src//config//" + platform
				+ "_config.properties");

		if (f.exists() && !f.isDirectory()) {
			lobConfigFis = new FileInputStream(file.getAbsoluteFile()
					+ "//src//config//" + platform + "_config.properties");
