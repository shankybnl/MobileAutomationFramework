...
public class LoginTest extends CreateSession {
    ...
    @Test(priority = 1)
    public void loginScreenVerification() throws InterruptedException, IOException {
        Thread.sleep(5000);
        logger = extent.createTest("Verification of Login Functionality");
        logger = logger.createNode("Login page display");
    ...
    @Test(priority = 2)
    public void loginScreenVerificationOne() throws InterruptedException, IOException {
        Thread.sleep(5000);
        logger = logger.createNode("Login page display one");
        logger.assignAuthor("Chetan");
        logger.assignCategory("Regression");
...
//        loginCoreLogic.loginScreenScenario();
    ...
    @Test(priority = 3)
    public void loginScreenVerificationTwo() throws InterruptedException, IOException {
        Thread.sleep(5000);
        logger = logger.createNode("Login page display two");
        logger.assignAuthor("Chetan");
        logger.assignCategory("Regression");

        Log.info("Running login page field verification test");

//		loginCoreLogic.loginScreenFieldScenario();

        Log.info("Verified all field displayed on login screen");
        logger.log(Status.INFO, "Verified all field displayed on login screen");
        logger.log(Status.INFO, "Verified all field displayed on login screen today");

    }

    @Test(priority = 4)
    public void loginScreenVerificationThree() throws InterruptedException, IOException {
        Thread.sleep(5000);
        logger = logger.createNode("Login page display three");
        logger.assignAuthor("Chetan");
        logger.assignCategory("Regression");
...
//        loginCoreLogic.loginScreenFieldScenario();
        ...
        Log.info("Verified all field displayed on login screen");
        logger.log(Status.INFO, "Verified all field displayed on login screen");
        logger.log(Status.INFO, "Verified all field displayed on login screen yesterday");
